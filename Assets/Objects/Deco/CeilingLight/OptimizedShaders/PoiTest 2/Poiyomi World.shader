Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/c164f6492b10a634c810a2fb1d62624a"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (float(0))
				{
					mainUV = sharpSample(float4(0.0078125,0.0078125,128,128), mainUV);
				}
				...
				poiFragData.baseColor = saturate(poiFragData.baseColor + float(-0.237) * hueShiftAlpha.g);
				#endif
				...
				clip(poiFragData.alpha - float(0.686));
