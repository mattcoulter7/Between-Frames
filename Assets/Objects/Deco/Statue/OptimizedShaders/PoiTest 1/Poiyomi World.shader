Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/16f2b49b649d30c4a84652cae1489d2b"
{
	Properties
	{
 ...
 #define PROP_LIGHTINGAOMAPS 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[float(0)], float4(1,1,0,0)), float4(0,0,0,0)), float(0.32));
