Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/fdf2bfbac81ecc3428f9dbfaacd92f12"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_FLAT 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,1,1,0.3137255).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,1,1,0.3137255).a;
 ...
 #define _LIGHTINGMODE_FLAT 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (float(2) != POI_MODE_TRANSPARENT)
				{
