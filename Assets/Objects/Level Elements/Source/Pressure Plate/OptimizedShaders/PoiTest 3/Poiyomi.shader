Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/8edff4f3f0344414987fd544629f617f"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			{
				float smoothness = float(0.454);
				float smoothness2 = float(1);
				float metallic = float(0.106);
