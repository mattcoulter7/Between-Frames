Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/b1fe6546ec39f964c84336c716b5ea5d"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = float(0.85);
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float4 mainTexture = UNITY_SAMPLE_TEX2D(_MainTex, poiUV(mainUV, float4(5,5,0,0)) + _Time.x * float4(0,0,0,0));
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,0.8016878,0,1).rgb, float(0));
				poiFragData.alpha = mainTexture.a * float4(1,0.8016878,0,1).a;
