Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/baed11b90ae14b248a82a9154cc3dd98"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiUV(poiMesh.uv[float(0)], float4(1,1,0,0)), float4(0,0,0,0)), float(1.5));
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), -float(0.15) * hueShiftAlpha.b);
				poiFragData.baseColor = saturate(poiFragData.baseColor + float(0.326) * hueShiftAlpha.g);
				#endif
				...
				clip(poiFragData.alpha - float(0.513));
