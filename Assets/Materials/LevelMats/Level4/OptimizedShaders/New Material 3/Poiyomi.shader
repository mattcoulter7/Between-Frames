Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Toon/e7b8ae2cf42f50f46837355ef911774a"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_REALISTIC 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor = saturate(poiFragData.baseColor + float(0.354) * hueShiftAlpha.g);
				#endif
